...
var userController = {
	...
	if (showAuthenticationElements) {
	    ...
	    this.uiElements.profileImage.attr('src', profile.picutre);
	...
	this.data.auth0Lock.on("authenticated", function(result) {
	    var token = result.accessToken;
	    this.getUserInfo(token, function(err, profile) {
		if (err) {
